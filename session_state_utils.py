...
def reset_all():
    # Examine Coil
    st.session_state['examine_skip'] = False
    ...
    # Trimming
    st.session_state['trimming_skip'] = False
    ...
    # Pickle & Oil
    st.session_state['pickle_skip'] = False
    ...
    # Coating
    st.session_state['coating_skip'] = False
    ...
    # Slitting
    st.session_state['slitting_skip'] = False
    st.session_state['slitting_widths_per_cut'] = [11.5, 11.5, 11.5, 11.5]
    st.session_state['slitting_num_cuts_needed'] = [1, 1, 1, 1]
    ...
    # Cut to Length
    st.session_state['cut_skip'] = False
    ...
    st.session_state['storage_start'] = 0.25
    st.session_state['storage_examine'] = 0.25
    st.session_state['storage_trimming'] = 0.25
    st.session_state['storage_pickle'] = 0.25
    st.session_state['storage_coating'] = 0.25
    st.session_state['storage_slitting'] = 0.25
    st.session_state['storage_cut'] = 0.25
    st.session_state['storage_end'] = 0.25
    # Freight (between steps)
    st.session_state['freight_start'] = 400.0
    st.session_state['freight_examine'] = 400.0
    st.session_state['freight_trimming'] = 400.0
    st.session_state['freight_pickle'] = 400.0
    st.session_state['freight_coating'] = 400.0
    st.session_state['freight_slitting'] = 400.0
    st.session_state['freight_cut'] = 400.0
    st.session_state['freight_end'] = 400.0
